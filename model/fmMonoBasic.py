...
# Filter implementation from Lab 1
...
if __name__ == "__main__":
	...
	if il_vs_th == 0:
		audio_coeff = signal.firwin(audio_taps, audio_Fc / (Fc/2), window=('hann'))
		audio_filt = signal.lfilter(audio_coeff, 1.0, fm_demod)
	else:
		audio_coeff = filter(Fc, audio_Fc, audio_taps)
		audio_filt = convolve(fm_demod, audio_coeff)
